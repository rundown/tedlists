...
def application(environ, start_response):
    ...
    if environ['PATH_INFO'] == '/health':
        ...
        if "delta=" in environ['QUERY_STRING']:
            ...
            delta_videos = mongo_db.videos.find({"_timestamp": {"$gt": timedelta}}, {"_id": 1, "_title": 1, "_author": 1})
            g_response["videos"] = []
...
<section class='container'>
          <hgroup>
            <h1>Welcome to Gaurav's TEDList App on OpenShift</h1>
          </hgroup>
        ...
        <div class="row">
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h2>Why don't you use the Youtube API</h2>

                <h3>TL;DR</h3>
                <p>Youtube API v3 doesn't completely cater to my needs and is bulky and pathetically round about.</p>

                <h3>The long one</h3>
                <p>If I was that interested in writing this, I would have used used the Youtube API instead.</p>
